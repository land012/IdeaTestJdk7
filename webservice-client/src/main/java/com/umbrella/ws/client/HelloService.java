 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws.umbrella.com/", wsdlLocation = "http://localhost:8080/com.umbrella.ws.Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://ws.umbrella.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/com.umbrella.ws.Hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://ws.umbrella.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.umbrella.com/", "HelloPort"), Hello.class, features);
    }
