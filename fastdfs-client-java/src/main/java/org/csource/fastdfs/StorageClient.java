...
*/
	...
	* @return 0 for success, != 0 for error (error no)
	*/
	public int modify_file(String group_name, String appdender_filename, 
			long file_offset, String local_filename) throws IOException, Exception
	{
		...
		try
		{
		  return this.do_modify_file(group_name, appdender_filename, file_offset, 
	...
	* @param group_name the group name of appender file
	* @param appdender_filename the appender filename
	* @param file_offset the offset of appender file
	* @param file_buff file content/buff
	* @return 0 for success, != 0 for error (error no)
	*/
